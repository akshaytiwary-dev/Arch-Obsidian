...
export const quickApps: LauncherApp[] = [
  {
    ...
    app_launch: (monitor) => {
      ...
      const keyBindsWidget =
        leftPanelWidgetSelectors.find((widget) => widget.name === "KeyBinds") ||
        leftPanelWidgetSelectors[0];
      leftPanel.show();
      setGlobalSetting("leftPanel.widget", keyBindsWidget);
    },
    app_icon: "",
